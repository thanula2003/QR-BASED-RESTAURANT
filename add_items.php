...
$specialItemsCount = 0;
$categories = [];  // Add this line to initialize the array
$categoryItems = []; // Also good practice to initialize this
...
foreach ($allItems as $item) {
    ...
    // Prepend new items to maintain reverse order
    array_unshift($categoryItems[$category], $item);
...
.sidebar-overlay.active {
  ...
  visibility: visible;
    ...
    /* Make sure the select doesn't have a browser-default arrow */
    select::-ms-expand {
      display: none;
    }
</style>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="custom-select-wrapper">
            <select id="itemCategory" class="form-control custom-select">
      ...
      function bindItemEventListeners() {
          ...
          document.querySelectorAll('.edit-item-btn').forEach(btn => {
              btn.addEventListener('click', (e) => {
                  ...
                  const itemId = card.dataset.id; // Remove parseInt() - keep as string
          ...
          document.querySelectorAll('.delete-item-btn').forEach(btn => {
              btn.addEventListener('click', (e) => {
                  const card = e.target.closest('.menu-card');
                  itemToDelete = card.dataset.id; // Remove parseInt() - keep as string
                  openDeleteModal();
              });
          });
      }
...
function sortItems() {
    ...
    items.sort((a, b) => {
        // Extract numeric part from IDs like "I001"
        const numA = parseInt(a.dataset.id.substring(1));
        const numB = parseInt(b.dataset.id.substring(1));
